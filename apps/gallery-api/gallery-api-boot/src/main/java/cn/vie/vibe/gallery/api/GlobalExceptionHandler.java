...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiError> domain(DomainException exception, HttpServletRequest request) {
        HttpStatus status = switch (exception.code()) {
            ...
            case "RESOURCE_NOT_FOUND", "GALLERY_NOT_FOUND", "PHOTO_NOT_FOUND", "TASK_NOT_FOUND", "MEMBERSHIP_NOT_FOUND", "CONFIG_NOT_FOUND", "CONFIG_VERSION_NOT_FOUND", "SHARE_LINK_NOT_FOUND", "SHORT_LINK_NOT_FOUND", "SHORT_LINK_INVALID" -> HttpStatus.NOT_FOUND;
            ...
            case "DEPENDENCY_UNAVAILABLE", "STORAGE_UNAVAILABLE", "SHORT_CODE_GENERATION_FAILED" -> HttpStatus.SERVICE_UNAVAILABLE;
